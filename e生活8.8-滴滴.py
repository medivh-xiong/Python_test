...
target_time = datetime.datetime(2024, 7, 8, 9, 30, 10)
...
def send_request():
    try:
        res = requests.get(url='https://market-web.ofpay.com/h5/union/api/draw/interactiveIGoChoose/A1190954239447531520',
...
while result:
    ...
    if response.text.find('本周名额已抢光') != -1:
        ...
        print("抢购成功")
        exit()
    elif response.text.find('W1190955901243490305') != -1:
        print("抢购成功")
        exit()
    else:
        print('领取失败, 重新领取')
